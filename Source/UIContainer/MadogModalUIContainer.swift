...
open class MadogModalUIContainer<Token>: MadogUIContainer, ModalContext {
    ...
    override public func close(animated: Bool, completion: CompletionBlock?) -> Bool {
    ...
    public func closeModal(token: ModalToken, animated: Bool, completion: CompletionBlock?) -> Bool {
